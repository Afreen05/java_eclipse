...
public class Cat {
	...
	public Cat(String type,String eye_color,int age,String color,boolean healthy,String[] breed,float[] height,int[] total_cats,String[] food_brand,String[] colors,char[] gender) {
		this.type=type;
